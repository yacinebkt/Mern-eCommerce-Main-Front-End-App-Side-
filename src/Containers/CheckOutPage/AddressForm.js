...
import { MaterialButton, MaterialInput, } from "../../Components/MaterialUI/MaterielUI";
...
export default function AddressForm(props) {
  ...
  */
    ...
    if ( props.withoutLayout ) {
        return <div> {rendreAddressForm()} </div>
    }

    return (

        <div className="checkoutSetup" style={{background:"#f5faff"}}>
